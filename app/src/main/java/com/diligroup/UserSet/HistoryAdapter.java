...
public class HistoryAdapter extends BaseAdapter {
    ...
    private List<GetHistoryBean.ListBean> data_list;

    public HistoryAdapter(Context mCon, List<GetHistoryBean.ListBean> data_list) {
    ...
    public static void setIsSelected(HashMap<Integer, Boolean> isSelected) {
        HistoryAdapter.isSelected = isSelected;
    }
    @Override
    public int getCount() {
